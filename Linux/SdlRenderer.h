...
public:
	...
	virtual void UpdateFrame(RenderedFrame& frame) override;
	virtual void Render(RenderSurfaceInfo& emuHud, RenderSurfaceInfo& scriptHud) override;
	virtual void Reset() override;

	virtual void SetExclusiveFullscreenMode(bool fullscreen, void* windowHandle) override;
};
